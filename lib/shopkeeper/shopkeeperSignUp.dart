...
class _ShopkeeperSignUpState extends State<ShopkeeperSignUp> {
  ...
  var _shopType = ['Vegetables', 'Fruits', 'Grains','Poultry','Oils', 'Sweets', 'Others'];

  var _currentShopTypeSelected = 'Vegetables';
  ...
  void validateAndSubmit() {
    if (validateAndSave()) {
      FirebaseAuth.instance.createUserWithEmailAndPassword(
          ...
          password: _password)
          .then((SignedInUser){
        UserManagement().storeNewShopkeeper(SignedInUser,context);
      }).catchError((e) {
        print(e);
      });
    } else {
                        ...
                        Container(
                          ...
                          child: DropdownButton<String>(
                            ...
                            onChanged: (String newValueSelected) {
                              setState(() {
                                this._currentShopTypeSelected =
                                    newValueSelected;
                              });
                            },
                            value: _currentShopTypeSelected,
                          ),
                        ),
                        SizedBox(
                          height: 10.0,
