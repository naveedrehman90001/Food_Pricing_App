...
import 'package:kp_pricing_system/mainPages/notifications.dart';
import 'package:kp_pricing_system/services/crud.dart';
import 'package:kp_pricing_system/shopkeeper/singleShopList.dart';
...
class _ShopkeeperDashboardState extends State<ShopkeeperDashboard>{
  ...
  @override
  void initState() {
    crudObj.getFruitsData().then((results) {
      setState(() {
        product = results;
      });
    });
